                                  ...
                                  
{
    ...
    $aemail = $_POST["aemail"];
	$aphone = $_POST["aphone"];
    $qry = "update admin set aemail='$aemail', aphone='$aphone' where aid='$id'";
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body">
									<h5 class="card-title">Admin Detail</h5>
...
while($row=mysqli_fetch_array($result)){
    ...
    <div class="form-group">
                                            ...
                                            <input style="width: 100%" class="form-control" name="aemail" type="text" value='<?php echo $row['aemail']; ?>' required>
                                        </div>
                                        <div class="form-group">
                                            <label>Change Contact Number <span style="color: red;">*</span></label>
                                            <input style="width: 100%" class="form-control" type="text" name="aphone" value='<?php echo $row['aphone'];   ?>' required >
                                        </div>
