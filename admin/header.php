					...
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									<li><a href="adminlist.php"> Admin </a>
								</li>
									<li><a href="register.php"> Add sub-admin </a></li>
									<li><a href="adduser.php"> Add User/Seller </a></li>
							...
							<li class="submenu">
								<a href="#"><i class="fe fe-browser"></i> <span> Report </span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
									<li><a href="reportproperty.php"> Property Report </a></li>
									<li><a href="sellerreport.php"> Seller Report </a></li>
